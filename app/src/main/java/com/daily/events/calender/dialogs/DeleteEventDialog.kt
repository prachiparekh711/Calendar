...
import com.daily.events.calender.helpers.DELETE_ALL_OCCURRENCES
import com.daily.events.calender.helpers.DELETE_FUTURE_OCCURRENCES
import com.daily.events.calender.helpers.DELETE_SELECTED_OCCURRENCE
...
class DeleteEventDialog(
    ...
    init {
        val view = activity.layoutInflater.inflate(R.layout.dialog_delete_event, null).apply {
            ...
            if (eventIds.size > 1) {
                delete_event_repeat_description.text =
                    resources.getString(R.string.selection_contains_repetition)
            }
        }
