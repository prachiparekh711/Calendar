package com.daily.events.calender.Activity.widgetActivity
...
import com.daily.events.calender.Extensions.addDayEvents
import com.daily.events.calender.Extensions.addDayNumber
...
import com.daily.events.calender.helpers.MyWidgetMonthlyProvider
    ...
    private fun updateDays() {
        ...
        for (i in 0 until len) {
            findViewById<LinearLayout>(resources.getIdentifier("day_$i", "id", packageName)).apply {
                ...
                context.addDayNumber(dayTextColor, day, this, dayLabelHeight) {
                    dayLabelHeight = it
                }
