...
import com.daily.events.calender.Extensions.handleEventDeleting
import com.daily.events.calender.Extensions.shareEvents
import com.daily.events.calender.Model.ListItem
import com.daily.events.calender.R
import com.daily.events.calender.dialogs.DeleteEventDialog
    ...
    private fun setupListSection(view: View, listSection: ListSection, position: Int) {
        view.event_section_title.apply {
            ...
            setCompoundDrawablesWithIntrinsicBounds(
                null,
                if (position == 0) null else topDivider,
                null,
                null
            )
            var color =
