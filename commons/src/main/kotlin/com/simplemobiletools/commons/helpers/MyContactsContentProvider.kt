                ...
                cursor?.use {
                    if (cursor.moveToFirst()) {
                        do {
                            ...
                            val phoneNumbers =
                                Gson().fromJson<ArrayList<String>>(phoneNumbersJson, token)
                                    ?: ArrayList()
                            val birthdays = Gson().fromJson<ArrayList<String>>(birthdaysJson, token)
                                ?: ArrayList()
                            val anniversaries =
                                Gson().fromJson<ArrayList<String>>(anniversariesJson, token)
                                    ?: ArrayList()
